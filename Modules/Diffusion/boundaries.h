...
public:
  ...
  /**
   * \brief Construct an inhomogeneous Dirichlet boundary.
   * \param boundary_value The boundary value.
   */
...
public:
  ...
  /**
   * \brief Construct a mon-reflective boundary.
   * \param boundary_value The boundary value.
   */
...
{
public:
    double a = 0.25; ///< The scaling factor for the solution.
    double b = 0.5;  ///< The scaling factor for the solution gradient.
    double f = 0.0;  ///< The source term.
...
public:
   ...
   * \param a_value The scaling factor for the solution.
   * \param b_value The scaling factor for the solution gradient.
   * \param f_value The source term.
   */
