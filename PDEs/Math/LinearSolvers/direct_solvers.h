...
namespace Math
{
  namespace LinearSolver
  {
    ...
    public:
       ...
       * reordering the right-hand side vector \f$ b \f$ according to the pivot
       * mapping vector. Next, the solution \f$ x \f$ is computed using the
       * previous definition  \f$ U x = y \f$ where \f$ y \f$ is now the
